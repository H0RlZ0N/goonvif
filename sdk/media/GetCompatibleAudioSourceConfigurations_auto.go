...
func Call_GetCompatibleAudioSourceConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetCompatibleAudioSourceConfigurations) (media.GetCompatibleAudioSourceConfigurationsResponse, error) {
