...
func Call_GetAudioOutputConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetAudioOutputConfigurations) (media.GetAudioOutputConfigurationsResponse, error) {
