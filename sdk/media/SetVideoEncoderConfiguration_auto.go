...
func Call_SetVideoEncoderConfiguration(ctx context.Context, dev *goonvif.Device, request media.SetVideoEncoderConfiguration) (media.SetVideoEncoderConfigurationResponse, error) {
