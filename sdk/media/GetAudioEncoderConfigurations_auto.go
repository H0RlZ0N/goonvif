...
func Call_GetAudioEncoderConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetAudioEncoderConfigurations) (media.GetAudioEncoderConfigurationsResponse, error) {
