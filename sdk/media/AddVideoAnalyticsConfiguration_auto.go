...
func Call_AddVideoAnalyticsConfiguration(ctx context.Context, dev *goonvif.Device, request media.AddVideoAnalyticsConfiguration) (media.AddVideoAnalyticsConfigurationResponse, error) {
