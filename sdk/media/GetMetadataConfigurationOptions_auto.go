...
func Call_GetMetadataConfigurationOptions(ctx context.Context, dev *goonvif.Device, request media.GetMetadataConfigurationOptions) (media.GetMetadataConfigurationOptionsResponse, error) {
