...
func Call_GetAudioEncoderConfiguration(ctx context.Context, dev *goonvif.Device, request media.GetAudioEncoderConfiguration) (media.GetAudioEncoderConfigurationResponse, error) {
