...
func Call_AddAudioSourceConfiguration(ctx context.Context, dev *goonvif.Device, request media.AddAudioSourceConfiguration) (media.AddAudioSourceConfigurationResponse, error) {
