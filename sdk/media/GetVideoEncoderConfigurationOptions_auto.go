...
func Call_GetVideoEncoderConfigurationOptions(ctx context.Context, dev *goonvif.Device, request media.GetVideoEncoderConfigurationOptions) (media.GetVideoEncoderConfigurationOptionsResponse, error) {
