...
func Call_GetCompatibleAudioEncoderConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetCompatibleAudioEncoderConfigurations) (media.GetCompatibleAudioEncoderConfigurationsResponse, error) {
