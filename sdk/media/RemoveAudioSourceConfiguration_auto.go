...
func Call_RemoveAudioSourceConfiguration(ctx context.Context, dev *goonvif.Device, request media.RemoveAudioSourceConfiguration) (media.RemoveAudioSourceConfigurationResponse, error) {
