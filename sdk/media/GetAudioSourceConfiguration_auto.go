...
func Call_GetAudioSourceConfiguration(ctx context.Context, dev *goonvif.Device, request media.GetAudioSourceConfiguration) (media.GetAudioSourceConfigurationResponse, error) {
