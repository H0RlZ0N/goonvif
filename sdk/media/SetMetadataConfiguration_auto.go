...
func Call_SetMetadataConfiguration(ctx context.Context, dev *goonvif.Device, request media.SetMetadataConfiguration) (media.SetMetadataConfigurationResponse, error) {
