...
func Call_GetCompatibleAudioOutputConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetCompatibleAudioOutputConfigurations) (media.GetCompatibleAudioOutputConfigurationsResponse, error) {
