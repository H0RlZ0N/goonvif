...
func Call_GetCompatibleVideoSourceConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetCompatibleVideoSourceConfigurations) (media.GetCompatibleVideoSourceConfigurationsResponse, error) {
