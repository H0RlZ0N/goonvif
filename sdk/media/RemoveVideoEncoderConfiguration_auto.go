...
func Call_RemoveVideoEncoderConfiguration(ctx context.Context, dev *goonvif.Device, request media.RemoveVideoEncoderConfiguration) (media.RemoveVideoEncoderConfigurationResponse, error) {
