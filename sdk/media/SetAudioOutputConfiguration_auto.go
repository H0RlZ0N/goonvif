...
func Call_SetAudioOutputConfiguration(ctx context.Context, dev *goonvif.Device, request media.SetAudioOutputConfiguration) (media.SetAudioOutputConfigurationResponse, error) {
