...
func Call_GetServiceCapabilities(ctx context.Context, dev *goonvif.Device, request media.GetServiceCapabilities) (media.GetServiceCapabilitiesResponse, error) {
