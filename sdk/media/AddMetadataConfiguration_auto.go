...
func Call_AddMetadataConfiguration(ctx context.Context, dev *goonvif.Device, request media.AddMetadataConfiguration) (media.AddMetadataConfigurationResponse, error) {
