...
func Call_RemoveVideoAnalyticsConfiguration(ctx context.Context, dev *goonvif.Device, request media.RemoveVideoAnalyticsConfiguration) (media.RemoveVideoAnalyticsConfigurationResponse, error) {
