...
func Call_GetMetadataConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetMetadataConfigurations) (media.GetMetadataConfigurationsResponse, error) {
