...
func Call_GetAudioDecoderConfigurations(ctx context.Context, dev *goonvif.Device, request media.GetAudioDecoderConfigurations) (media.GetAudioDecoderConfigurationsResponse, error) {
