...
func Call_RemoveMetadataConfiguration(ctx context.Context, dev *goonvif.Device, request media.RemoveMetadataConfiguration) (media.RemoveMetadataConfigurationResponse, error) {
