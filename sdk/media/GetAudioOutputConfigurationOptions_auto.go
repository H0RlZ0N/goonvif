...
func Call_GetAudioOutputConfigurationOptions(ctx context.Context, dev *goonvif.Device, request media.GetAudioOutputConfigurationOptions) (media.GetAudioOutputConfigurationOptionsResponse, error) {
