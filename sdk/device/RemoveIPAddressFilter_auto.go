...
func Call_RemoveIPAddressFilter(ctx context.Context, dev *goonvif.Device, request device.RemoveIPAddressFilter) (device.RemoveIPAddressFilterResponse, error) {
