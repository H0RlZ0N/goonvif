...
func Call_UpgradeSystemFirmware(ctx context.Context, dev *goonvif.Device, request device.UpgradeSystemFirmware) (device.UpgradeSystemFirmwareResponse, error) {
