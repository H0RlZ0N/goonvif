...
func Call_CreateDot1XConfiguration(ctx context.Context, dev *goonvif.Device, request device.CreateDot1XConfiguration) (device.CreateDot1XConfigurationResponse, error) {
