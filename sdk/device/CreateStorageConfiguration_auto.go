...
func Call_CreateStorageConfiguration(ctx context.Context, dev *goonvif.Device, request device.CreateStorageConfiguration) (device.CreateStorageConfigurationResponse, error) {
