...
func Call_GetStorageConfigurations(ctx context.Context, dev *goonvif.Device, request device.GetStorageConfigurations) (device.GetStorageConfigurationsResponse, error) {
