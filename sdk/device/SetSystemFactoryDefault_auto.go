...
func Call_SetSystemFactoryDefault(ctx context.Context, dev *goonvif.Device, request device.SetSystemFactoryDefault) (device.SetSystemFactoryDefaultResponse, error) {
