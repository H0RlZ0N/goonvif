...
func Call_SetStorageConfiguration(ctx context.Context, dev *goonvif.Device, request device.SetStorageConfiguration) (device.SetStorageConfigurationResponse, error) {
