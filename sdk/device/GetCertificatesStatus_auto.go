...
func Call_GetCertificatesStatus(ctx context.Context, dev *goonvif.Device, request device.GetCertificatesStatus) (device.GetCertificatesStatusResponse, error) {
