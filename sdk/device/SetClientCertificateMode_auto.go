...
func Call_SetClientCertificateMode(ctx context.Context, dev *goonvif.Device, request device.SetClientCertificateMode) (device.SetClientCertificateModeResponse, error) {
