...
func Call_GetClientCertificateMode(ctx context.Context, dev *goonvif.Device, request device.GetClientCertificateMode) (device.GetClientCertificateModeResponse, error) {
