...
func Call_GetDot1XConfigurations(ctx context.Context, dev *goonvif.Device, request device.GetDot1XConfigurations) (device.GetDot1XConfigurationsResponse, error) {
