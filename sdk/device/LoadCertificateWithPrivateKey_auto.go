...
func Call_LoadCertificateWithPrivateKey(ctx context.Context, dev *goonvif.Device, request device.LoadCertificateWithPrivateKey) (device.LoadCertificateWithPrivateKeyResponse, error) {
