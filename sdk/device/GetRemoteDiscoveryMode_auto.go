...
func Call_GetRemoteDiscoveryMode(ctx context.Context, dev *goonvif.Device, request device.GetRemoteDiscoveryMode) (device.GetRemoteDiscoveryModeResponse, error) {
