...
func Call_GetServiceCapabilities(ctx context.Context, dev *goonvif.Device, request device.GetServiceCapabilities) (device.GetServiceCapabilitiesResponse, error) {
