...
func Call_SetNetworkDefaultGateway(ctx context.Context, dev *goonvif.Device, request device.SetNetworkDefaultGateway) (device.SetNetworkDefaultGatewayResponse, error) {
