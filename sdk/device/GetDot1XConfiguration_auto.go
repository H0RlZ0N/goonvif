...
func Call_GetDot1XConfiguration(ctx context.Context, dev *goonvif.Device, request device.GetDot1XConfiguration) (device.GetDot1XConfigurationResponse, error) {
