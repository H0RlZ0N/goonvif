...
func Call_GetCertificateInformation(ctx context.Context, dev *goonvif.Device, request device.GetCertificateInformation) (device.GetCertificateInformationResponse, error) {
