...
func Call_SetDot1XConfiguration(ctx context.Context, dev *goonvif.Device, request device.SetDot1XConfiguration) (device.SetDot1XConfigurationResponse, error) {
