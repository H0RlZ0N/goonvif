...
func Call_SetRemoteDiscoveryMode(ctx context.Context, dev *goonvif.Device, request device.SetRemoteDiscoveryMode) (device.SetRemoteDiscoveryModeResponse, error) {
